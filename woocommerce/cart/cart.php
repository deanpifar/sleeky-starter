    ...
    <?php do_action( 'woocommerce_before_cart_table' ); ?>
      ...
      <table class="sleekyCartTable__table">
        ...
        <thead>
          <tr>
            <td>
              <p>Your cart<span><?php echo WC()->cart->get_cart_contents_count(); ?> items</span></p>
            </td>
            <td>Quantity</td>
            <td>Price</td>
            <td>Subtotal</td>
          ...
          <tr class="sleekyCartTable__item woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
            ...
            <td class="product-information sleekyCartTable__information">
              ...
              <div class="sleekyCartTable__information__description">
                <h2><?php if ( ! $product_permalink ) { echo wp_kses_post( $product_name . '&nbsp;' ); } else { echo wp_kses_post( apply_filters( 'woocommerce_cart_item_name', sprintf( '<a href="%s">%s</a>', esc_url( $product_permalink ), $_product->get_name() ), $cart_item, $cart_item_key ) ); } ?></h2>
                <?php if( $_product->get_description() ) { ?>
            ...
            <td class="product-quantity sleekyCartTable__quantity">
              ...
              ?>   
                ...
                <button class="sleekyCartTable__quantity__decrease" onClick="decreaseQuantity(this);">-</button>
